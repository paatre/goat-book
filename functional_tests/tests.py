...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        edisth_list_url = self.browser.current_url
        self.assertRegex(edisth_list_url, "/lists/.+")

        # Now a new user, Francis, comes a lon to the site.

        ## We delete all the browser's cookies
        ## as a way of simulating a brand new user session
        self.browser.delete_all_cookies()

        # Francis visits the home page. There is no sin of Edith's
        # list
        self.browser.get(self.live_server_url)
